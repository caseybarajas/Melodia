...
def main():
    ...
    logger.info(f"Training config: max_epochs={training_config.max_epochs}, batch_size={training_config.batch_size}")
    ...
    # Debug: Count training data
    batch_count = sum(1 for _ in train_dataset)
    logger.info(f"Training dataset has {batch_count} batches")
